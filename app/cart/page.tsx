          ...
          {cart.length === 0 ? (
            <div className="bg-white rounded-xl shadow-sm border p-12 text-center">
              ...
              <p className="text-gray-500 mb-8">
                Browse our catalogue to add industrial products to your cart.
              </p>
              <Link
                href="/products"
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
              <div className="lg:col-span-8 space-y-4">
                {cart.map((item) => (
                  <div
                    key={item.productId}
                    className="bg-white rounded-xl shadow-sm border p-6 flex flex-col sm:flex-row items-center justify-between gap-4"
                  >
                    <div className="flex-1">
                      <h3 className="text-lg font-medium text-gray-900">
                        {item.name}
                      </h3>
                      <p className="text-sm text-gray-500">HSN: {item.sku}</p>
